<footer class="site-footer" style="margin:10px;padding:10px;">
	<div class="container">
        ...
        <div class="text-center">
            <h2>Chuồn chuồn - Dự báo thời tiết</h2>
            <i>"Chuồn chuồn bay thấp thì mưa. Bay cao thì nắng. Bay vừa thì râm"</i>
            <br>
            <h2>Đồ Án chuyên ngành 1 - GVHD: <b>TS. Phạm Nguyễn Minh Nhựt</b></h2>
            <h2>Sinh viên thực hiện:</h2>
            <h2>Nguyễn Quang Hoàng Vũ - 18IT118 - Nguyễn Anh Triết - 18IT111</h2>
        </div>
